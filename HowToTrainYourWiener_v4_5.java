 ...
 */
public class HowToTrainYourWiener_v4_5 extends JFrame {
    ...
    public HowToTrainYourWiener_v4_5() {
        initializeGame();
        setupUI();
        updateUI();
        startLoop();
    ...
    private void setupUI() {
        ...
        JScrollPane scrollPane = new JScrollPane(root, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED, JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new HowToTrainYourWiener_v4_5());
    }
}
