...
public class HowToTrainYourWiener_v1_11 {
        ...
        dogLabel = new JLabel("") {
            @Override protected void paintComponent(Graphics g) {
                ...
                if ("LEGENDARY".equals(currentStage)) {
                    ...
                    g2.fillOval(cx - gap - bw + ox, cy - bh/2 + oy, bw, bh);
                    // --- sack skin base (right ball) ---
                    g2.fillOval(cx + gap/2 + ox, cy - bh/2 + oy, bw, bh);

                    // --- shading / depth (left) ---
                    g2.setColor(new Color(185, 110, 70, 140));
                    g2.fillOval(cx - gap - bw + 6 + ox, cy - bh/2 + 8 + oy, bw - 10, bh - 10);
                    // --- shading / depth (right) ---
                    g2.fillOval(cx + gap/2 + 4 + ox, cy - bh/2 + 8 + oy, bw - 10, bh - 10);

                    // --- highlight (left) ---
                    g2.setColor(new Color(255, 210, 175, 130));
                    g2.fillOval(cx - gap - bw + 8 + ox, cy - bh/2 + 6 + oy, 14, 12);
                    // --- highlight (right) ---
                    g2.fillOval(cx + gap/2 + 10 + ox, cy - bh/2 + 6 + oy, 14, 12);

                    // --- centre crease / divot line ---
                    g2.setColor(new Color(160, 85, 50, 180));
                    g2.setStroke(new BasicStroke(2.5f, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND));
                    g2.drawLine(cx + ox, cy - bh/2 + 4 + oy, cx + ox, cy + bh/2 - 4 + oy);
                    g2.setStroke(new BasicStroke(1));

                    // --- wrinkle lines (left ball) ---
                    g2.setColor(new Color(160, 85, 50, 100));
                    g2.setStroke(new BasicStroke(1.2f, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND));
                    g2.drawArc(cx - gap - bw + 10 + ox, cy - 6 + oy, 20, 12, 10, 160);
                    g2.drawArc(cx - gap - bw + 14 + ox, cy + 6 + oy, 16, 10, 20, 140);
                    // --- wrinkle lines (right ball) ---
                    g2.drawArc(cx + gap/2 + 8 + ox, cy - 6 + oy, 20, 12, 10, 160);
                    g2.drawArc(cx + gap/2 + 12 + ox, cy + 6 + oy, 16, 10, 20, 140);
                    g2.setStroke(new BasicStroke(1));

                    // --- outline (left) ---
                    g2.setColor(new Color(140, 70, 40, 160));
                    g2.drawOval(cx - gap - bw + ox, cy - bh/2 + oy, bw, bh);
                    // --- outline (right) ---
                    g2.drawOval(cx + gap/2 + ox, cy - bh/2 + oy, bw, bh);

                    // --- crown on top (it's LEGENDARY after all) ---
                    g2.setColor(new Color(255, 215, 0));
                    int[] crownX = {cx - 14 + ox, cx - 14 + ox, cx - 7 + ox, cx + ox, cx + 7 + ox, cx + 14 + ox, cx + 14 + ox};
                    int[] crownY = {cy - bh/2 - 2 + oy, cy - bh/2 - 14 + oy, cy - bh/2 - 8 + oy, cy - bh/2 - 16 + oy, cy - bh/2 - 8 + oy, cy - bh/2 - 14 + oy, cy - bh/2 - 2 + oy};
                    ...
                    g2.fillOval(cx - 11 + ox, cy - bh/2 - 17 + oy, 5, 5);
                    g2.fillOval(cx - 2 + ox,  cy - bh/2 - 19 + oy, 5, 5);
                    g2.fillOval(cx + 7 + ox,  cy - bh/2 - 17 + oy, 5, 5);
